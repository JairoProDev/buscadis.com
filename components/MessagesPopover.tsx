...
export default function MessagesPopover({ onClose, onOpenConversation }: MessagesPopoverProps) {
    ...
    if (loading && conversations.length === 0) {
        return (
        <div className="w-full animate-fade-in-down rounded-2xl border border-[var(--border-color)] bg-[var(--bg-primary)] p-4 shadow-[var(--popover-shadow)]">
    ...
    return (
        <div className="flex w-full flex-col overflow-hidden rounded-2xl border border-[var(--border-color)] bg-[var(--bg-primary)] shadow-[var(--popover-shadow)]">
