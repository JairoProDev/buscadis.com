...
export const metadata: Metadata = {
  ...
  description:
    'Publica y encuentra adisos en Perú. Un adiso es el anuncio de Buscadis: empleos, inmuebles, vehículos, servicios, productos, eventos y negocios.',
  keywords: [
    'adiso',
    'adisos',
    'publicar adiso',
  ...
  openGraph: {
    ...
    description:
      'Publica tu adiso. Empleos, inmuebles, vehículos, servicios y más. Anuncios clasificados en Perú.',
