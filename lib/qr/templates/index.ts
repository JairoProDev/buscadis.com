...
export async function buildKitSvg(
  ...
  const qr400 = await getQrImageTag(input, 400);
  const qr320 = await getQrImageTag(input, 320);
  const qr280 = await getQrImageTag(input, 280);
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ${shadow}
  <rect width="${w}" height="${h}" rx="32" fill="#ffffff" filter="url(#softShadow)"/>
  <rect x="0" y="0" width="${w}" height="12" rx="32" fill="url(#brandGrad)"/>
  <rect x="0" y="${h - 12}" width="${w}" height="12" rx="32" fill="url(#brandGrad)"/>
  <g transform="translate(100, 48)">${qr400}</g>
  <text x="${w / 2}" y="500" text-anchor="middle" font-family="${font}" font-size="28" font-weight="700" fill="#0f172a">${name}</text>
  <text x="${w / 2}" y="536" text-anchor="middle" font-family="${font}" font-size="16" fill="#64748b">${tagline}</text>
  <rect x="${w / 2 - 80}" y="560" width="160" height="36" rx="18" fill="${color}" opacity="0.12"/>
  <text x="${w / 2}" y="584" text-anchor="middle" font-family="${font}" font-size="13" font-weight="600" fill="${color}">Escanea aquí</text>
  <text x="${w / 2}" y="660" text-anchor="middle" font-family="${font}" font-size="11" fill="#94a3b8">buscadis.com</text>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(286, 50) scale(0.35)">${qr400}</g>
</svg>`;
      return { svg, width: w, height: h, mime: 'image/svg+xml' };
    }
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(340, 670)">${qr400}</g>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(380, 920)">${qr320}</g>
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(197, 280) scale(0.75)">${qr400}</g>
  ...
  <g transform="translate(197, 820) scale(0.75)">${qr400}</g>
</svg>`;
      return { svg, width: w, height: h, mime: 'image/svg+xml' };
    }
...
<svg xmlns="http://www.w3.org/2000/svg" width="${w}" height="${h}" viewBox="0 0 ${w} ${h}">
  ...
  <g transform="translate(257, 450)">${qr280}</g>
