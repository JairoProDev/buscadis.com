...
export const publishCta = {
  ...
  labelColor: 'color-mix(in srgb, var(--bs-color-sol-500) 75%, var(--text-primary))',
  background:
    'linear-gradient(145deg, var(--bs-color-sol-300) 0%, var(--bs-publish-bg, var(--brand-yellow)) 48%, var(--bs-color-sol-500) 100%)',
  backgroundActive:
    'linear-gradient(145deg, var(--bs-color-sol-200) 0%, var(--bs-publish-bg, var(--brand-yellow)) 55%, var(--bs-color-sol-600) 100%)',
  shadow:
