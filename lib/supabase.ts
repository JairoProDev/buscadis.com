...
export function dbToAdiso(row: any): Adiso {
  ...
  return {
    ...
    contactLocked: row.contact_locked ?? false,
...
export function adisoToDb(adiso: Adiso): any {
  ...
  const dbData: any = {
    ...
    subcategoria: adiso.subcategoria || null,
    subsubcategoria: adiso.subsubcategoria || null,
    atributos: adiso.atributos || {},
    contact_locked: adiso.contactLocked ?? false,
    payment_status: adiso.paymentStatus || (adiso.esGratuito ? 'free' : 'verified'),
