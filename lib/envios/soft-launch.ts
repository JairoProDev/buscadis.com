...
export const PILOT_LAUNCH = {
  ...
  steps: [
    ...
    '5. En el grupo WA: “También pide en Buscadis Delivery” + link; no apagar el grupo hasta que tiempo-a-aceptación app ≤ WA.',
    '6. Usuarios: Envío → Otro + descripción clara para traslados (camuflaje); no mencionar pasajero en marketing.',
