...
const rawNegocio = {
  ...
  modulos: [
    ...
    { tipo: 'categorias' as const, visible: true, orden: 6 },
    { tipo: 'ia' as const, visible: true, orden: 7 },
    { tipo: 'promocion' as const, visible: true, orden: 8 },
    { tipo: 'resenas' as const, visible: true, orden: 9 },
    { tipo: 'ubicacion' as const, visible: true, orden: 10 },
    { tipo: 'horario' as const, visible: true, orden: 11 },
    { tipo: 'pago' as const, visible: true, orden: 12 },
    { tipo: 'canales' as const, visible: true, orden: 13 },
