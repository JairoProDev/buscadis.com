...
const rawNegocio = {
  ...
  contacto: {
    ...
    redes: [
      ...
      { tipo: 'messenger', url: 'https://m.me/buscadis', activa: true },
      { tipo: 'tiktok', url: 'https://tiktok.com/@buscadis', activa: true },
      { tipo: 'kwai', url: 'https://www.kwai.com/@buscadis', activa: true },
      { tipo: 'youtube', url: 'https://youtube.com/@buscadis', activa: true },
      { tipo: 'linkedin', url: 'https://linkedin.com/company/buscadis', activa: true },
      { tipo: 'x', url: 'https://x.com/buscadis', activa: true },
      { tipo: 'telegram', url: 'https://t.me/buscadis', activa: true },
      { tipo: 'threads', url: 'https://threads.net/@buscadis', activa: true },
      { tipo: 'pinterest', url: 'https://pinterest.com/buscadis', activa: true },
      { tipo: 'snapchat', url: 'https://snapchat.com/add/buscadis', activa: true },
      {
        tipo: 'maps',
        url: 'https://maps.google.com/?q=-13.522,-71.967',
        activa: true,
      },
      {
        tipo: 'tripadvisor',
      ...
      { tipo: 'spotify', url: 'https://open.spotify.com', activa: true },
      { tipo: 'twitch', url: 'https://twitch.tv/buscadis', activa: true },
      { tipo: 'discord', url: 'https://discord.gg/buscadis', activa: true },
      { tipo: 'behance', url: 'https://behance.net/buscadis', activa: true },
      { tipo: 'vimeo', url: 'https://vimeo.com/buscadis', activa: true },
      { tipo: 'soundcloud', url: 'https://soundcloud.com/buscadis', activa: true },
      { tipo: 'github', url: 'https://github.com/buscadis', activa: true },
      { tipo: 'medium', url: 'https://medium.com/@buscadis', activa: true },
      { tipo: 'reddit', url: 'https://reddit.com/r/buscadis', activa: true },
      {
        tipo: 'google',
        url: 'https://www.google.com/search?q=Buscadis',
        activa: true,
      },
    ],
  },
  ...
  modulos: [
    ...
    { tipo: 'novedades' as const, visible: true, orden: 4 },
    { tipo: 'catalogo' as const, visible: true, orden: 5 },
    { tipo: 'ia' as const, visible: true, orden: 6 },
    { tipo: 'promocion' as const, visible: true, orden: 7 },
    { tipo: 'resenas' as const, visible: true, orden: 8 },
    { tipo: 'ubicacion' as const, visible: true, orden: 9 },
    { tipo: 'horario' as const, visible: true, orden: 10 },
    { tipo: 'pago' as const, visible: true, orden: 11 },
    { tipo: 'canales' as const, visible: true, orden: 12 },
    { tipo: 'galeria' as const, visible: true, orden: 13 },
    { tipo: 'nosotros' as const, visible: true, orden: 14 },
    { tipo: 'faq' as const, visible: true, orden: 15 },
  ],
  conteos: {
    productos: 4,
    resenas: 4,
  ...
  return {
    ...
    novedades: [
      ...
      },
      {
        ...
        texto: 'Abrimos de 8 a 13',
        publicadaEn: new Date(now.getTime() - 5 * 86400000).toISOString(),
        imagenUrl: placeholder('Horario', 28),
      },
    ],
    equipo: [],
    certificaciones: [],
