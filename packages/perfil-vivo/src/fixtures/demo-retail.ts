...
const rawNegocio = {
  ...
  modulos: [
    ...
    { tipo: 'ia' as const, visible: true, orden: 5 },
    { tipo: 'promocion' as const, visible: true, orden: 6 },
    { tipo: 'resenas' as const, visible: true, orden: 7 },
    { tipo: 'ubicacion' as const, visible: true, orden: 8 },
    { tipo: 'horario' as const, visible: true, orden: 9 },
    { tipo: 'pago' as const, visible: true, orden: 10 },
    { tipo: 'novedades' as const, visible: true, orden: 11 },
